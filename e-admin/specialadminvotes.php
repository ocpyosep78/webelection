...
//Purpose: Function to allow adminstration of "special votes". We don't use it and I'd like to cut it
...
<?php
$sqlq = "SELECT * FROM specialvoters ORDER by id ASC";
...
while($row = mysql_fetch_array($sqlresult)) {
	print "<tr><td>".$row['id']."</td><td>".$row['lastname']."</td><td>".$row['firstname']."</td><td><a href=\"deletespecialvote.php?id=".$row['id']."\" onclick=\"return confirm('This action cannot be undone. Are you sure you want to proceed?');\">Delete Votes</a></td></tr>";
}
